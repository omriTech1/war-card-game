var a=Object.defineProperty;var t=(e,o)=>a(e,"name",{value:o,configurable:!0});import{b as n,j as c}from"./jsx-runtime.fc9a0e28.js";import{p as s}from"./index.d2277da1.js";import"./iframe.5bce173d.js";const r=t(({score:e,name:o})=>n("div",{className:"flex gap-x-4",children:[c("div",{className:"w-fit px-5 py-1 font-mono outline outline-2",children:e}),n("span",{children:[o," "]})]}),"ScoreTicker"),i=r;r.defaultProps={score:0};r.propTypes={score:s.exports.PropTypes.number,name:s.exports.PropTypes.string};r.__docgenInfo={description:"",methods:[],displayName:"ScoreTicker",props:{score:{defaultValue:{value:"0",computed:!1},type:{name:"number"},required:!1,description:""},name:{type:{name:"string"},required:!1,description:""}}};const g={parameters:{storySource:{source:`import React from 'react';
...
//# sourceMappingURL=ScoreTicker.stories.c923df6b.js.map
